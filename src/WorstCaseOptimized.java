...
public class WorstCaseOptimized {
    ...
    public static void main(String[] args) {
        ...
        runFullExperiment("LCSubstringOptimizedWorst-Exp1.txt");
        System.out.println("Running second full experiment...");
        runFullExperiment("LCSubstringOptimizedWorst-Exp2.txt");
        System.out.println("Running third full experiment...");
        runFullExperiment("LCSubstringOptimizedWorst-Exp3.txt");
    }
    ...
    public static void verifyWorks(){
        ...
        WorstCaseOptimized.search(a1,b1);
    }
    ...
    public static WorstCaseOptimized search(String str1, String str2){
        ...
        return new WorstCaseOptimized(result, result.length());
    }

    // constructor
    public WorstCaseOptimized(String result, int length) {
        this.result = result;
        this.length = length;
    }
